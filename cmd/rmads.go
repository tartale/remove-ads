...
func init() {
	...
	rootCmd.PersistentFlags().StringVarP(&config.Values.InputFilePath, "input", "i", "", "Input file; defaults to stdin")
	rootCmd.PersistentFlags().StringVarP(&config.Values.OutputFilePath, "output", "o", "", "Output file; defaults to stdout")
